...
var (
	...
	userReceiveAddressRowsExpectAutoSet   = strings.Join(stringx.Remove(userReceiveAddressFieldNames, "`id`", "`create_time`", "`update_time`"), ",")
	userReceiveAddressRowsWithPlaceHolder = strings.Join(stringx.Remove(userReceiveAddressFieldNames, "`id`", "`create_time`", "`update_time`"), "=?,") + "=?"
